...
export default function Hero(){
    ...
    return(
        <section className='w-[80%] h-[70vh] grid grid-rows-2 lg:grid lg:grid-cols-2'>
            <motion.article initial={{ opacity: 0, x: -100 }} whileInView={{ opacity: 1, x: 0 }} className='grid h-[70vh] z-[2] lg:z-0 content-evenly'>
            ...
            <motion.section initial={{ opacity: 0, x: 100 }} whileInView={{ opacity: 1, x: 0 }} className='flex h-[70vh] items-end justify-center'>
