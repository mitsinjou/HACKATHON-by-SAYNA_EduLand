    ...
    return(
        <section className='w-[80%] h-[70vh] grid grid-cols-2'>
            <article className='grid content-evenly'>
                ...
                <Link href="#contact">
                    <button type='button' className='p-2.5 hover:bg-orange-400 bg-red-600 rounded-lg shadow justify-center items-center gap-2.5 inline-flex text-white text-lg font-semibold uppercase'>Demandez un devis</button>
                </Link>
            </article>
            <section className='flex items-end justify-center'>
                ...
                <button type="submit" className='mx-4 p-2.5 hover:bg-orange-400 bg-red-600 rounded-lg shadow justify-center items-center gap-2.5 inline-flex text-white text-lg font-semibold'>Rechercher</button>
                </form>
            </section>
        </section>
    )
